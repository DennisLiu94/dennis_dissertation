...
def load_and_pred(state,channel):
    ...
    #test_loss,y_pred=coling.test(test_sen_x,test_pos_label_x,test_ner_x,test_wnsyn_x,test_dep_x,test_dep_path_x,test_pos_x,test_y,e_pos,test_sen_len,npt['i'](0))
    ###################
    #batch test
    size=3000
    batchs=int(np.ceil(len(test_sen_x)*1.0/size))
    print len(test_sen_x)
    y_pred=None    
    test_loss=0
    y_x=None
