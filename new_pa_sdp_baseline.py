...
if __name__ == '__main__':
    ...
    if test:
        ...
        launch(sdp_file='./data/full.sdp_idx',loadmodel=True,idx2emb='glove_100_idx2emb.pkl',datapath='./data',dataset='blstm_complete_input_len95',n_epoches=1000,batchsize=400,sen_dropout=0.5,lex_dropout=0.0,layers=[400],suffix='',word_fea_emb={'pos':5,'pos_label':20,'ner':20,'wnsyn':20,'dep':20,'dep_path':10, 'com_dep_path':20})
