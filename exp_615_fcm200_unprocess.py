...
if __name__ == '__main__':
    ...
    test=True
    if test:
        launch(loadmodel=False,idx2emb='fcm_200_idx2emb.pkl',datapath='./data',dataset='blstm_complete_input_len95_mini',n_epoches=3,batchsize=13,
        ...
        launch(loadmodel=False,idx2emb='fcm_200_idx2emb.pkl',datapath='./data',dataset='blstm_complete_input_len95',n_epoches=300,batchsize=200,sen_dropout=0.5,lex_dropout=0.0,layers=[400],suffix='',word_fea_emb={'pos':5,'pos_label':20,'ner':20,'wnsyn':20,'dep':20,'dep_path':10, 'com_dep_path':20})
