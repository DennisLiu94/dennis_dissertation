...
class RMM_BLSTM(object):
    ...
    def __init__(self,rng,word_num,emb_dim,sen_len,cs,pos_max,pos_emb_len,lex_len,ex_fea_len,conv_output_col,n_hidden,label_num,sen_dropout,lex_dropout,layers,max_word_fea_size,word_fea_emb):
        ...
        '''
        self.pos_sen_x=T.concatenate([self.emb.E[self.sen_idx[:,:,1]],self.e1_pos_emb.E[self.pos_idx[:,:,0]],self.e2_pos_emb.E[self.pos_idx[:,:,1]]],axis=2).dimshuffle(0,2,1)
        ...
        self.input_size=self.emb.D+self.e1_pos_emb.D+self.e2_pos_emb.D
        ##############
        #remove slip window
       ...
       # logic_W=theano.shared(value=logic_W_values,name='W',borrow=True)
        ...
        emb_params=[self.e1_pos_emb.E,self.e2_pos_emb.E,self.emb.E]
