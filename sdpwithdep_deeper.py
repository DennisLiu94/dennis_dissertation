...
class RMM_BLSTM(object):
    ...
    def __init__(self,deprel_num,rng,word_num,emb_dim,sen_len,cs,pos_max,pos_emb_len,lex_len,ex_fea_len,conv_output_col,n_hidden,label_num,sen_dropout,lex_dropout,layers,max_word_fea_size,word_fea_emb):
        ...
        self.lstm_layer_2=BLSTMLayer(rng=rng,
        ...
        self.lstm_layer_3=BLSTMLayer(rng=rng,
       ...
       # self.debug_check_lstm_output=theano.function([self.sen_idx,self.pos_idx],[self.lstm_layer.all_output])
        ...
        (lstm_output_1,lstm_output_size_1)=simple_max(self.lstm_layer.all_output,self.lstm_layer.output_size)
        (lstm_output_2,lstm_output_size_2)=simple_max(self.lstm_layer_2.all_output,self.lstm_layer_2.output_size)
        (lstm_output_3,lstm_output_size_3)=simple_max(self.lstm_layer_3.all_output,self.lstm_layer_3.output_size)
...
if __name__ == '__main__':
    ...
    if test:
        ...
        launch(sdp_file='./data/sdp_with_deprel_dataset',loadmodel=False,idx2emb='glove_100_idx2emb.pkl',datapath='./data',dataset='blstm_complete_input_len95',n_epoches=1000,batchsize=200,sen_dropout=0.5,lex_dropout=0.0,layers=[400,200,100],suffix='',word_fea_emb={'pos':5,'pos_label':20,'ner':20,'wnsyn':20,'dep':20,'dep_path':10, 'com_dep_path':20})
